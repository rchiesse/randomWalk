...
#Import CSV data
with open("./stats/fractionInfected_gnp_N1000_AG1000_T0.1_G0.022_L2_Wi0.6_Ws0.6_STime2000_R3.csv", "r") as i :
...
with open("./stats/Runge-Kutta_gnp_N1000_AG1000_T0.1_G0.022_L2_Wi0.6_Ws0.6_STime2000_R3.csv", "r") as j :
...
plt.savefig("./plots/fractionInfected_gnp_N1000_AG1000_T0.1_G0.022_L2_Wi0.6_Ws0.6_STime2000_R3.pdf")
#plt.show()
