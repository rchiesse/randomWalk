...
static constexpr uint T					= 50;						// ----> Simulation time.
...
static constexpr real GAMMA_a			= 2.6;							// ----> Recovery rate. The higher, the faster. Parameter of an exponentially-distributed random-number generator.
