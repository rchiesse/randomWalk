...
static constexpr uint NUM_AGENTS		= 400;							// ----> Total number of agents in a simulation.
...
static constexpr real GAMMA				= 0.0141;						// ----> Recovery rate. The higher, the faster. Parameter of an exponentially-distributed random-number generator.
