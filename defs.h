...
static constexpr real GAMMA_a			= 3.0;							// ----> Recovery rate. The higher, the faster. Parameter of an exponentially-distributed random-number generator.
...
static constexpr real LAMBDA			= 10.0;							// ----> Walking speed. The higher, the faster. Parameter of an exponentially-distributed random-number generator.
